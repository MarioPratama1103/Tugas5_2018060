...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.MakananViewHolder> {
    String data1[], data2[], data3[];
    int images[];
    Context context;
    public ItemAdapter(Context ct, String s1[], String s2[], String s3[], int  img[]){
        context = ct;
        data1 = s1;
        data2 = s2;
        data3 = s3;
    ...
    @NonNull
    @Override
    public ItemAdapter.MakananViewHolder
    ...
    @Override
    public void onBindViewHolder(@NonNull ItemAdapter.MakananViewHolder holder, int position) {
